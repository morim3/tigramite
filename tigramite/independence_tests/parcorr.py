...
from .independence_tests_base import CondIndTest, CondIndTestAtomic

class ParCorrAtomic(CondIndTestAtomic):
    ...
    **kwargs :
    ...
    @staticmethod
    def get_analytic_significance(value, T, dim, xyz):
    ...
    @staticmethod
    def get_analytic_confidence(value, df, conf_lev):
